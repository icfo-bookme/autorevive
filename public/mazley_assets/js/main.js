(function ($) {
    ...
    /*---product column6 activation---*/
       $('.product_column6').on('changed.owl.carousel initialized.owl.carousel', function (event) {
        ...
        /*---product column7activation---*/
        $('.product_columnSeven').on('changed.owl.carousel initialized.owl.carousel', function (event) {
            $(event.target).find('.owl-item').removeClass('last').eq(event.item.index + event.page.size - 1).addClass('last')}).owlCarousel({
            loop: true,
            nav: true,
            autoplay: false,
            ...
            items: 6,
             margin: 20,
            dots:false,
            navText: ['<i class="ion-ios-arrow-back btnPrevious"></i>','<i class="ion-ios-arrow-forward btnNext"></i>'],
            responsiveClass:true,
            responsive:{
                    0:{
                    items:1,
        ...
        $('.product_columnSix').on('changed.owl.carousel initialized.owl.carousel', function (event) {
            $(event.target).find('.owl-item').removeClass('last').eq(event.item.index + event.page.size - 1).addClass('last')}).owlCarousel({
            loop: true,
            nav: true,
            autoplay: false,
