        ...
        (b.Bar = (function (c) {
            ...
            return (
                ...
                (d.prototype.drawBar = function (a, b, c, d, e, f, g) {
                    var h, i;
                    return (h = Math.max.apply(Math, g)), (i = 0 === h || h > d ? this.raphael.rect(a, b, c, d) : this.raphael.path(this.roundedRect(a, b, c, d, g))), i.getAttribute("fill", e).attr("fill-opacity", f).attr("stroke", "none");
                }),
