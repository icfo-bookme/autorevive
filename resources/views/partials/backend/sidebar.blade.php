<div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
    ...
    @php
        ...
        $stockModuleEdit =env('STOCK_PRICE_EDIT_ROLE'); /* 15 */
        $managerRole =env('MAINTAINER_ROLE'); /* 16 */
        $hopRole =env('HOP_ROLE');
        $accountsRole =env('ACCOUNTS_ROLE');
        $posOperatorRole =env('POSOPERATOR_ROLE');
        ...
        $pending_drafted_purchases = App\purchase\PurchaseDraft::where(['soft_delete' => 0,'is_purchased' => 0])->count();
    ...
    <div class="user-details">
        <div class="media align-items-center user-pointer collapsed" data-toggle="collapse" data-target="#user-dropdown">
            <div class="avatar"><img class="mr-3 side-user-img"
                ...
                alt="user avatar">{{AUth::user()->email}}
            </div>
        ...
        <ul class="sidebar-menu">
                ...
                <a href="javaScript:void(0);" class="waves-effect">
                    ...
                    <span>Customer
                        ...
                        $pending_product_requests = App\Product\ProductRequest::where('soft_delete', 0)
                            ->where('is_approved', 0)
                            ->count();
                        $total = $pending_product_requests;
                        ?>
                        @if ($total != 0)
            ...
            <li>
                ...
                <ul class="sidebar-submenu">
                    ...
                    <li>
                        <a href="{{ url('bookedOrdersView') }}"><span><i class="ti-layout-grid3-alt"></i></span>All Bookings
                    ...
                    <li>
                        <a href="{{ url('cancelledSalesView') }}"><i class="ti-layout-grid3-alt"></i>Cancelled Sales</a>
                    </li>
                </ul>
            </li>
        </ul>
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                ...
                <ul class="sidebar-submenu">
                    ...
                    <li>
                        <a href="{{ url('pickupOrderView') }}"><span><i class="ti-layout-grid3-alt"></i></span>Pickup Orders
    ...
    @elseif (in_array($itemInsertRole, $roles))
        <ul class="sidebar-menu">
            ...
            <li>
                ...
                <ul class="sidebar-submenu">
                    <li>
                        <a href="{{ url('allSubCategoryView') }}"><i class="ti-layout-grid3-alt"></i>All Sub-Categories</a>
                    </li>
            ...
            <li>
                ...
                <ul class="sidebar-submenu">
                    <li>
                        <a href="{{ url('companySetupView') }}"><i class="ti-layout-grid3-alt"></i>Car Company Setup</a>
                    </li>
                    <li>
                        <a href="{{ url('allCompaniesView') }}"><i class="ti-layout-grid3-alt"></i>All Car Companies</a>
                    </li>
                    <li>
                        <a href="{{ url('carBrandSetupView') }}"><i class="ti-layout-grid3-alt"></i>Car Brand Setup</a>
                    </li>
                    <li>
                        <a href="{{ url('allCarBrandsView') }}"><i class="ti-layout-grid3-alt"></i>All Car Brands</a>
                    </li>
                    <li>
                        <a href="{{ url('carModelSetupView') }}"><i class="ti-layout-grid3-alt"></i>Car Model Setup</a>
                    </li>
                    <li>
                        <a href="{{ url('allCarModelsView') }}"><i class="ti-layout-grid3-alt"></i>All Car Models</a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul class="sidebar-submenu">
                    ...
                    <li>
                        <a href="{{ url('deliveryChargeView') }}"><i class="ti-layout-grid3-alt"></i>Website Delivery Charge</a>
                    </li>
            ...
            <li>
                ...
                <ul class="sidebar-submenu">
                    ...
                    <li>
                        <a href="{{ url('allDraftedPurchaseView') }}"><span><i class="ti-layout-grid3-alt"></i></span>Purchase Drafts
    ...
    @elseif (in_array($stockModuleEdit, $roles))
        <ul class="sidebar-menu">
            <li class="sidebar-header">MAIN NAVIGATION</li>
            <li>
                <a href="javaScript:void(0);" class="waves-effect">
    ...
    @elseif (in_array($managerRole, $roles) || in_array($hopRole, $roles) || in_array($accountsRole,$roles))
        ...
        <ul class="sidebar-menu">
            ...
            {{-- <li>
                <a href="javaScript:void(0);" class="waves-effect">
                    <i class="zmdi zmdi-layers"></i>
                    <span>User Register</span><i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="sidebar-submenu">
                    <li>
                        <a href="{{ url('/admin/adminPanelRegister') }}"><i class="ti-layout-grid3-alt"></i>User Register</a>
                    </li>
                    <li>
                        <a href="{{ url('admin/rolesAssignUser') }}"><i class="ti-layout-grid3-alt"></i>User Role Assign</a>
                    </li>
                </ul>
            </li> --}}
            ...
            <li>
                <a href="javaScript:void(0);" class="waves-effect">
                    <i class="zmdi zmdi-layers"></i><span>Accounts</span> <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="sidebar-submenu">

                    <li><a href="{{ url('cashStoragePlatformView') }}"><i class="ti-layout-grid3-alt"></i>Ending Balance</a></li>
                    <li>
                    ...
                    <li>
                        <a href="{{ url('endingBalanceReport') }}"><i class="ti-layout-grid3-alt"></i>Ending Balance Report</a>
                    </li>
            ...
            <li>
                ...
                <ul class="sidebar-submenu">
                    ...
                    <li>
                        <a href="{{ url('smsSettingView') }}"><i class="ti-layout-grid3-alt"></i>SMS</a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul class="sidebar-submenu">
                    ...
                    <li>
                        <a href="{{ route('due_collection_history.view') }}"><i class="ti-layout-grid3-alt"></i>Due Collection History</a>
                    </li>

                    <li>
                        <a href="{{ url('salesCompletedView') }}"><i class="ti-layout-grid3-alt"></i>Completed Sales</a>
                    </li>
            ...
            <li>
                ...
                <ul class="sidebar-submenu">
                    ...
                    {{-- @if(in_array($hopRole, $roles) || in_array($accountsRole, $roles)) --}}
                        <li>
    ...
    @elseif (in_array($posOperatorRole, $roles))
        <ul class="sidebar-menu">
            <li class="sidebar-header">MAIN NAVIGATION</li>
            <li>
                <a href="javaScript:void(0);" class="waves-effect">
                    ...
                    <span>Customer
                        ...
                        $pending_product_requests = App\Product\ProductRequest::where('soft_delete', 0)
                            ...
                            ->count();
                        $pending_welcome_calls = App\welcomeCall\WelcomeCallModel::where('status', 0)->count();
                        $total = $pending_product_requests + $pending_welcome_calls;
                        ?>
                        @if ($total != 0)
                            <span class="badge badge-primary">{{ $total }}</span>
                        @endif
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                ...
                <ul class="sidebar-submenu">
                    ...
                    <li>
                        <a href="{{ url('admin/roleInsert') }}"><i class="ti-layout-grid3-alt"></i>Role create</a>
                    </li>
                    <li>
                        <a href="{{ url('admin/moduleInsert') }}"><i class="ti-layout-grid3-alt"></i>Module create</a>
                    </li>
                    <li>
                        <a href="{{ url('admin/rolesAssign') }}"><i class="ti-layout-grid3-alt"></i>Role Module Assign</a>
                    </li>
                    <li>
