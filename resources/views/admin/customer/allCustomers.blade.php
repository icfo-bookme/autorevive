...
@section('content')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-3" style="display: flex; justify-content:space-between;align-items:center">
                        <div>
                            <button class="btn btn-outline-info" onclick="window.open('{{ url('smsTemplateView') }}')">Add
                                Template</button>
                        ...
                        <div style="display: flex; justify-content:flex-end;align-items:center">
                            <div class="form-group mx-2" style="min-width: 200px; margin-bottom: 0px;">
                                <select class="form-control" id="thanaName" onchange="getAllCustomers(this.value)">
                    ...
                    <div class="table-responsive">
                        <table id="allCustomerTable" class="table table-bordered" style="width: 100% !important;">
                            <thead>
                                <tr>
                                    <th data-orderable="false"><input id="selectAll" value="1" type="checkbox"></th>
                    ...
                    <form id="customerInfoInsertForm">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody id="customer_details">
                                            <tr>
                                                ...
                                                <td class="my-3">
                                                    <input type="text" class="form-control" id="car_no"
                                                        name="car_no[]" placeholder="car number">
                                                </td>
                                            </tr>
                        ...
                        <div class="form-footer text-center">
                            ...
                            <button type="button" class="btn btn-danger waves-effect waves-light"
                                onclick="clearForm()"><i class="fa fa-times"></i>Cancel</button>
                        </div>
                            ...
                            @foreach ($referrals as $referral)
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="referral_method[]"
                                        id="{{ $referral->id }}" value="{{ $referral->id }}">
            ...
            <div class="modal-content animated flipInX">
                ...
                <form id="smsForm" method="post">
                    ...
                    <div class="modal-footer justify-content-center">
                        <button type="submit" class="btn btn-info" name="sendSms" id="sendSms"><i
    ...
    <script>
        ...
        $(document).ready(function() {
            let getThana = $('#thanaName').val();
            getAllCustomers(getThana);
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                if (response.status === true) {
                                    ...
                                    alertify.error("<span class='text-white'>" +
        ...
        function getAllCustomers(thana) {
        ...
        function addRow() {
            ...
            markup += '<td>';
            markup +=
                '<input type="text" class="form-control checkValid" id="first_name" name="first_name[]" placeholder="first name">';
            markup += '</td>'
            ...
            markup += '<td>';
            markup +=
                '<input type="text" class="form-control checkValid" id="phone_number" name="phone_number[]" placeholder="phone number" required="required">';
            markup += '</td>';
