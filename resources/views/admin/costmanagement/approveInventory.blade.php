    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h2 style="font-size: 23px;text-align: center">CASHFLOW APPROVAL BY INVENTORY</h2>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">
                                      ...
                                      <table class="table table-bordered inventoryTable">
                                          ...
                                          <tbody>
                                              ...
                                              <tr>
                                                  ...
                                                  <td>{{ $inventory->payable_amount }}</td>
                                                  <td>
                                                      <button class="btn btn-outline-secondary"
                                                          onclick="approveByInv({{ $inventory->id }})">
                                                          <i class="fa fa-check icon__size"></i>
                                                      </button>
                                                      {{-- @if ($inventory->is_approved_by_inventory)
                                                        <button class="btn btn-outline-secondary" disabled>
                                                            <i class="fa fa-check icon__size"></i>
                                                        </button>
                                                      @else
                                                        <button class="btn btn-outline-secondary" 
                                                            onclick="approve({{ $inventory->id }})">
                                                            <i class="fa fa-check icon__size"></i>
                                                        </button>
                                                      @endif --}}
                                                  </td>
                            ...
                            <div id="tabe-2" class="tab-pane fade">
                                <div class="table-responsive">
                                    <table class="table table-bordered inventoryTable">
                                        ...
                                        <tbody>
                                            @foreach($inventoryapproved as $inventory)
                                            <tr>
                                                <td>{{ $inventory->user->first_name." ".$inventory->user->last_name }}</td>
                                                <td>{{ $inventory->date }}</td>
                                                <td>{{ $inventory->description}}</td>
