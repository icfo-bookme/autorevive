    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h2 style="font-size: 23px;text-align: center">CASHFLOW APPROVAL BY SUPPLYCHAIN</h2>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">
                          ...
                          <div class="tab-content">
                            <div id="tabe-1" class="tab-pane active">
                              <div class="table-responsive">
                                  <table class="table table-bordered supplychainTable">
                                      <thead>
                                      <tr>
                                          <th>User</th>
                                          <th>Date</th>
                                      ...
                                      <tbody>
                                          @foreach($supplyChainInfo as $info)
                                          <tr>
                            ...
                            <div id="tabe-2" class="tab-pane fade">
                                <div class="table-responsive">
                                    <table class="table table-bordered supplychainTable">
                                        ...
                                        <tbody>
                                            @foreach($supplyapproved as $info)
                                            <tr>
                                                <td>{{ $info->user->first_name." ".$info->user->last_name }}</td>
                                                <td>{{ $info->date }}</td>
                                                <td>{{ $info->description}}</td>
