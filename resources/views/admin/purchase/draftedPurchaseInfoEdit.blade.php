...
@endphp
                ...
                <div class="card-body">
                    <form id="purchaseUpdateForm">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="py-3">
                                                        <input type="number" step="any" min="0" class="form-control"
                                                            ...
                                                            placeholder="sales pmount" required>
                                                    </td>
                        ...
                        <div class="form-footer text-center">
                            <button type="button" class="btn btn-success" onclick="submitDraftedPurchase();"><i class="fa fa-check-square-o"></i> DONE </button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h6 class="text-danger">Please Select Item!</h6>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function submitDraftedPurchase() {
            ...
            console.log("in item id array ", itemIdCount.length);
            console.log('hamida',getDatas.length);
            console.log('hamida',deleted_items.length);
            
            let due = $('#due_amount').val();
            if(due == 0){
                if(dataArr.length == itemIdCount.length){
                    if(dataArr.length>0 && itemIdCount.length>0 || getDatas.length>0){
                        ...
                        function() {
                            ...
                            var formData = new FormData($('#purchaseUpdateForm')[0]);
                            formData.append('deletedItems', deleted_items);
                            console.log("form data console......", formData);
                            
                            $.ajax({
                                type: 'post',
                                url: '{{ url('draftedPurchaseUpdateAjax') }}',
                                data: formData,
                                dataType: 'json',
                                ...
                                success: function(response) {
                                    ...
                                    if(response.status === true){
                                        ...
                                        setTimeout(function() {
                                            location.href = "{{ url('allDraftedPurchaseView') }}";
                                        }, 4000);
