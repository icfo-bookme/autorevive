                ...
                <div class="card-body">
                    <form id="purchaseInsertForm">
                        ...
                        <h4 class="form-header text-uppercase text-center">
                            ...
                            Drafted Purchase Setup
                        </h4>
                        <p class="text-center">
                            Drafted Amount:{{$draft->amount}}
                        </p>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="py-3">
                                                    ...
                                                    <input type="number" step="any" min="{{$draft->amount}}" class="form-control"
                                                        onkeyup="paidAmount()" id="paid_amount" 
                                                        name="paid_amount"  value="{{$draft->amount}}" placeholder="Paid Amount" required readonly>
                                                </td>
                                                <td class="py-3">
