            ...
            <div class="card-body">
                                ...
                                @foreach ($paymentMethods as $paymentMethod)
                                   ...
                                   <div class="col-lg-3">
                                    <div class="icheck-material-primary">
                                        <input type="radio" class="radio" id="{{$paymentMethod->id}}" name="payment_method_id" value="{{$paymentMethod->id}}" @if($paymentMethod->payment_method == 'Cash')checked @endif>
                                        <label for="{{$paymentMethod->id}}">{{$paymentMethod->payment_method}}</label>
                                    </div>
                                    {{-- <!-- <div class="form-check">
                                        <input type="checkbox" name="payment_method_id" value="{{$paymentMethod->id}}">
                                        <label class="form-check-label" for="{{$paymentMethod->id}}">{{$paymentMethod->payment_method}}</label>
                                    </div> --> --}}
                                </div>
                ...
                <div class="row" style="margin-top:20px">
                    <div class="col text-center">
                        <button class="btn btn-primary" onclick="paymentCollect({{ $order->id }})">Payment Collect</button>
                        {{-- <button class="btn btn-danger" onclick="location.href = `{{ URL('collectPayment') }}`">Cancel</button> --}}
                        <button class="btn btn-danger" onclick="location.replace(document.referrer)">Cancel</button>
                    </div>
                </div>
                @else
...
<script>
    ...
    //          event.preventDefault();
    //          alertify.confirm('Are You Sure ?', 'Delivery man Will be assign.', function () {
    ...
    //                     alertify.success(data);
    //                     setTimeout(function () {
    //                        location.href = "{{ url('approvedOrderView') }}";
    //                     }, 1000)
