...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header"><i class="fa fa-table"></i> Cancelled Order View</div>
            <div class="card-body">
                <div class="clearfix"></>
                <div class="table-responsive">
                    <table id="cancelOrderTable" class="table table-bordered" style="width: 100% !important;">
                        ...
                        <tbody>
                            ...
                            <tr style="text-align:center;">
                                ...
                                <td>
                                    <a class="custom_textDecoration" href="{{url('CancelledDetailsView',$order->id)}}" style="cursor: pointer">
                                ...
                                <td>
                                    {{-- <a href="{{url('CancelledDetailsView',$order->id)}}"
...
<script>
    $(document).ready(function () {
        ...
        var table = $('#cancelOrderTable').DataTable({
