                        ...
                        <table class="table table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" step="any" class="form-control" value="{{$item->price}}"
                                            readonly>
                                    </td>
...
<div class="modal fade" id="modal-shipment" style="display: none;" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
                ...
                <form id="deliveryManAssign">
                    {{-- <div class="col-md-12">
                     <select class="form-control" name="team_leader" id="team_leader">
                         ...
                         <option value="{{$leader->user->id}}">{{$leader->user->name}}</option>
                    @endforeach
                    </select>
            </div> --}}
        ...
        <div class="modal-footer justify-content-center">
            ...
            <button type="button" onclick="deliveryManAssign()" class="btn btn-success"><i
...
<script>
    function cancelShipment(id) {
        ...
        alertify.confirm('Are You Sure ?', 'Order Will Be Cancel?', function () {
