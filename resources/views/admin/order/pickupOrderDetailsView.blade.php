            ...
            <div class="card-body">
                        ...
                        <table class="table table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><b>{{ $totalAmount + $shipmentChargeAmount }}</b></td>
                                </tr>
                ...
                <div class="row" style="margin-top:20px">
                    <div class="col text-center">
                        <button class="btn btn-primary" onclick="pickupOrderApproved({{ $order->id }})">Pickup
                            Completed</button>
                        <button class="btn btn-warning" data-toggle="modal" data-target="#modal-reschedule">Pickup
                            Reschedule</button>
...
<script>
    function pickupOrderApproved(id) {
        event.preventDefault();

        alertify.confirm('Are You Sure ?', 'Pickup Completed?', function () {
            $.ajax({
                type: 'post',
                url: '{{URl("pickupOrderApprovedAjax")}}',
                data: {
                    id: id,
                    // order_code: value
                },
    ...
    function shipmentOrderReschedule(id) {
        ...
        if (reasonMessage == "") {
            ...
            alertify.confirm('Are You Sure ?', 'Pickup will be rescheduled?', function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (typeof data.errors !== 'undefined') {
                            ...
                            alertify.success(data);
                            location.href = "{{ url('pickupOrderView') }}";
