            ...
            <div class="card-body">
                ...
                {{-- <div class="row" style="margin-top:20px">
                    <div class="col text-center">
                        <button class="btn btn-primary" onclick="shipmentOrderApproved({{ $order->id }})">Shipment
                            Completed</button>
                        <button class="btn btn-warning" data-toggle="modal" data-target="#modal-reschedule">Shipment
                            Reschedule</button>
                ...
                <div class="row" style="margin-top:20px">
                    <div class="col text-center">
                        ...
                        <button class="btn btn-danger" onclick="location.href = '{{ url()->previous() }}'">Back</button>
                    </div>
                </div>
...
<script>
    function shipmentOrderApproved(id) {
        ...
        alertify.confirm('Are You Sure ?', 'data will be inset?', function () {
