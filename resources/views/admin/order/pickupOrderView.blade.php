...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header"><i class="fa fa-table"></i> Pickup Order View</div>
            <div class="card-body">
                <div class="clearfix"></div>
                <div class="table-responsive">
                    <table id="pickupOrderTable" class="table table-bordered" style="width: 100% !important;">
                            ...
                            <tr style="text-align:center;">
                                ...
                                <td>
                                    <a class="custom_textDecoration"
                                        href="{{url('pickupOrderDetailsView',$order->orders->id)}}" style="cursor: pointer">
                ...
                <form class="form" method="POST" id="updatePriorityForm">
                    <div class="form-body">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary" onclick="priorityUpdate()">
...
<script>
    $(document).ready(function () {
        ...
        var table = $('#pickupOrderTable').DataTable({
