...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header"><i class="fa fa-table"></i> Pending Order View</div>
            <div class="card-body">
                <div class="clearfix"></div>
                <div class="table-responsive">
                    <table id="pendingOrderTable" class="table table-bordered">
                        ...
                        <tbody>
                            @foreach ($orders as $order)
                                <tr style="text-align:center;">
                                    ...
                                    <td>
                                        <a class="custom_textDecoration" href="{{url('orderDetailsView',$order->id)}}" style="cursor: pointer">
                                    ...
                                    <td>{{$order->city}}</td>
                                    <td>
                                        {{-- <a href="{{url('orderDetailsView',$order->id)}}"
                                        ...
                                        <a href="{{url('orderDetailsView',$order->id)}}" 
                                            class="btn badge badge-secondary"  style="padding: 5px 10px;color: #fff;cursor: pointer;line-height: 10px">
                                            Details
                                        </a>
                                    </td>
                                </tr>
