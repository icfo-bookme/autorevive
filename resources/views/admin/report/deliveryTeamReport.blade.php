    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title mb-0">Delivery Team Report</h4>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="introduction-box mx-auto">
                        <h5 class="text-center">Automart</h5>
                        <p class="text-center">Delivery Team Report</p>
                    </div>
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="col-sm-3">
...
<script>
    function ajaxCall() {
        ...
        $("#ajaxLoad").load("./deliveryTeamReportAjax/" + fromDate + "/" + toDate + "/" + teamId, function(responseTxt, statusTxt, xhr){
