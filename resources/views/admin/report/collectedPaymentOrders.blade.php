                    ...
                    <div class="col-sm-12">
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                ...
                                {{-- <input type="date" class="form-control" id="toDate"> --}}
                                <select class="form-control form-control-sm-3" id="payment_method">
                                    <option  value="ALL">--- select all method ---</option>
...
function ajaxCall() {
   ...
   // var teamId = $("#teamId").val();
    // $("#ajaxLoad").load("./collectedPaymentOrdersAjax/" + fromDate + "/" + toDate +"/"+payment_method);

    $('#preloader').modal('show');
        $("#ajaxLoad").load("./collectedPaymentOrdersAjax/" + fromDate + "/" + toDate +"/"+payment_method, function(responseTxt, statusTxt, xhr){
