            ...
            <div class="card-body">
                <div class="row">
                    <div class="introduction-box mx-auto">
                        ...
                        <p class="text-center">Delivery Report</p>
                    </div>
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="col-sm-3">
...
<script>
    function ajaxCall() {
        ...
        // $("#ajaxLoad").load("./dailyDeliveryReportAjax/" + fromDate + "/" + toDate);

        $('#preloader').modal('show');
        $("#ajaxLoad").load("./dailyDeliveryReportAjax/" + fromDate + "/" + toDate, function(responseTxt, statusTxt, xhr){
