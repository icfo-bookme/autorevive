...
@section('content')
                ...
                <div class="card-body">
                    <form id="itemInsertForm">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" step="any" min="0" class="form-control" id="minimum_order_quantity"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <select class="form-control form-control-sm" id="is_published" name="is_published">
                                    <option disabled selected value="">---select---</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                ...
                                {{-- <button type="button" class="btn btn-danger" id="delete-specification" onclick="deleteSpecification()">
                                    <div class="fonticon-wrap">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            let item_id = myArray[4];
            get_data(item_id) //After page load this function called
                        ...
                        if(regularPrice < offerPrice) {
                            ...
                            success: function(data) {
                                ...
                                if (typeof data.errors !== 'undefined') {
                                    ...
                                    clearForm();
                                    setTimeout(function() {
                                        location.href = "{{ url('allItemsView') }}";
                                    }, 1000);
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (typeof data.errors !== 'undefined') {
                        ...
                        if (data.car_brand_id != null) {
                            if (data.car_brand_id.toString().length > 0) {
                                ...
                                if (carModels.length === 0) {
                                    ...
                                    $('#car_model_pivot').html(`<option disabled value=""> SELECT Model</option>`);
                                } else {
                        ...
                        const carModels = [];
                        $('#car_model_pivot').val(carModels).trigger('change');
