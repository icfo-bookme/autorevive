            ...
            <div class="card-body">
                <form id="moduleInsertForm">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="input-1" name="moduleName" required>
                        </div>
                    </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#moduleInsertForm').submit(function () {
            ...
            alertify.confirm("Are You Sure To Submit This?",
                function () {
                    $.ajax({
                        type: 'post',
                        url: './moduleInsertAjax',
                        data: $("#moduleInsertForm").serialize(),
                        dataType: 'json',
                        success: function (data) {
                            if (typeof data.errors !== 'undefined') {
                                ...
                                // setTimeout(function() {
                                //     window.location.href="{{URL::to('admin/modulesView')}}";
                                // },1000)
                                setTimeout(function() {
    ...
    function clearForm() {
        $('#moduleInsertForm').trigger("reset");
    }
