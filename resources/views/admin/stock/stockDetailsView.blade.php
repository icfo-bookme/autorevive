                            ...
                            <form class="form" method="POST" id="updateItemPriceForm">
                                <div class="form-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="regular_price" id="update_regular_price" value="{{$itemTable->regular_price}}" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="sales_price" id="update_sales_price" value="{{$itemTable->sales_price}}" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control form-control-sm" name="is_published" id="update_is_published" readonly>
                                        ...
                                        <tbody id="selected_tbl">
                                            ...
                                            <tr>
                                                ...
                                                <td class="whiteSpace_normal">
                                                    <button class="btn btn-info btn-xs" onclick="purchaseDetails({{$purchaseDetails->id}})">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" id="update_paid_amount" name="paid_amount" class="form-control square"
                                     oninput="paidAmount(this)" name="" readonly>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="number" step="any" min="1" class="form-control" id="update_quantity" name="quantity"
                                        oninput="setTotalAmount(this)" readonly>
                                </div>
                            </div>
                        </div>
                    </form>
...
<script>
    ...
    function purchaseDetails(purchaseDetailsId) {
        $.ajax({
